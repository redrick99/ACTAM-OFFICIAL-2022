...
export const modalScalesTextUpper = "Ionian Dorian Phrygian Lydian Mixolydian Aeolian Locrian".split(" ");
export const voicingsTypes =
  "Rootless A, Rootless B, Monk, Powell 1, Powell 2, Powell 3, Powell 4, Three Notes, Four Notes, Open Chord 1, Open Chord 2".split(
    ", "
  );
...
export const voicingNames = "Rootless, Monk, Powell, Three Notes, Four Notes, Open Chord".split(", ");
export const voicingType = "Type 1, Type 2, Type 3, Type 4".split(", ");
...
export const assignables = {
  currentKey: 0,
  currentMode: 0,
  currentVoicingName: 0,
  currentVoicingType: 0,
